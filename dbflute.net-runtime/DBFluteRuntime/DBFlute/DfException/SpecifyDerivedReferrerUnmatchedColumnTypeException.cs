 ...
 * @author jflute
 */
public class SpecifyDerivedReferrerUnmatchedColumnTypeException : RuntimeException {
     ...
     */
    public SpecifyDerivedReferrerUnmatchedColumnTypeException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
