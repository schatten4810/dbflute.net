 ...
 * @author jflute
 */
public class NonSetupSelectRelationAccessException : RuntimeException {

    /**
     * Constructor.
     * @param msg The message of the exception. (NotNull)
     */
    public NonSetupSelectRelationAccessException(String msg) {
        super(msg);
    }
     ...
     */
    public NonSetupSelectRelationAccessException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
