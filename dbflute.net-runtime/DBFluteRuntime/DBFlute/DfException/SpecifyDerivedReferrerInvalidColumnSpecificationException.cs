 ...
 * @author jflute
 */
public class SpecifyDerivedReferrerInvalidColumnSpecificationException : RuntimeException {
     ...
     */
    public SpecifyDerivedReferrerInvalidColumnSpecificationException(String msg, Throwable cause)
        : base(msg, cause)
    {
    }
}
