 ...
 * @author jflute
 */
public class QueryDerivedReferrerUnmatchedColumnTypeException : RuntimeException {
     ...
     */
    public QueryDerivedReferrerUnmatchedColumnTypeException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
