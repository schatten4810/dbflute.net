 ...
 */
public class DfPropFileReadFailureException : RuntimeException {

    public DfPropFileReadFailureException(String msg) {
        super(msg);
    }

    public DfPropFileReadFailureException(String msg, Throwable e) {
        super(msg, e);
    }
}
