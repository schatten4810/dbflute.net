 ...
 * @author jflute
 */
public class QueryAlreadyRegisteredException : RuntimeException {

    /**
     * Constructor.
     * @param msg The message of the exception. (NotNull)
     */
    public QueryAlreadyRegisteredException(String msg) {
        super(msg);
    }
     ...
     */
    public QueryAlreadyRegisteredException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
